...
void train_detector(char *datacfg, char *cfgfile, char *weightfile, int *gpus, int ngpus, int clear)
{
    ...
    while(get_current_batch(net) < net->max_batches){
        ...
        */
    	...
    	FILE *fp;
		//if ((fp = fopen("/home/rdt/Desktop/avgerror.txt", "w+")) == NULL ){
		if ((fp = fopen("avgerror.txt", "a")) == NULL ){
		//if ((fp = fopen("/home/rdt/Desktop/avgerror.txt", "a")) == NULL ){
            printf("wrong:\n");
        }
...
void test_detector(char *datacfg, char *cfgfile, char *weightfile, char *filename, float thresh, float hier_thresh, char *outfile, int fullscreen)
{
        ...
        if(filename)
	{
		...
		draw_detections_apple(input, im, l.w*l.h*l.n, thresh, boxes, probs, masks, names, alphabet, l.classes);
		//draw_detections_dog(im, l.w*l.h*l.n, thresh, boxes, probs, masks, names, alphabet, l.classes);
		if(outfile)
		{
	...
	else 
	{
	    ...
	    FILE * fp; 
            char * line = NULL;
	    char folder[128], type[128];
    	    size_t len = 0;
    	    ssize_t read;      
	    fp = fopen("data/apples/sets/test.txt", "r");
	    //fp = fopen("/home/rdt/Workspace/darknet/data/apples/sets/test.txt", "r");
		...
		strcpy(folder, "data/apples/images/");
		strcpy(type, ".png");
		strcpy(input, "");
